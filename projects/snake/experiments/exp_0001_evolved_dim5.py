"""exp_0001 -- evolved priority opens the Q_5 snake frontier (13 edges).

First frontier result (and the proven optimum at dim5) from the FunSearch evolution engine on the
...
dim-5 champion and record the snake length (edges).

novelty = frontier-search. Frontier: snake_len_dim5.
"""
...
MANIFEST = {
    ...
    "title": "Evolved priority builds a 13-edge snake in Q_5",
    "hypothesis": "The evolved champion priority builds a long valid snake in Q_5.",
