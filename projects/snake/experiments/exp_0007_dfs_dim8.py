"""exp_0007 -- bounded-backtracking improves the Q_8 snake frontier (81).

Greedy is myopic and plateaued at 76 (exp_0004). The trusted
...
MANIFEST = {
    ...
    "title": "Backtracking snake in Q_8 (81 edges)",
    "hypothesis": "Priority-guided backtracking beats the greedy snake frontier (76) in Q_8.",
    "falsifiable_prediction": "The path passes is_induced_path and exceeds 76.",
...
def run(budget_seconds: float) -> dict:
    ...
    prior = 76                                         # greedy frontier (exp_0004)
