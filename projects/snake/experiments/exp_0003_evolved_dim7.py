"""exp_0003 -- evolved priority opens the Q_7 snake frontier (46 edges).
...
dim-7 champion and record the snake length (edges).
...
MANIFEST = {
    ...
    "title": "Evolved priority builds a 46-edge snake in Q_7",
    "hypothesis": "The evolved champion priority builds a long valid snake in Q_7.",
