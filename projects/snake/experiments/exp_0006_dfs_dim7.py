"""exp_0006 -- bounded-backtracking improves the Q_7 snake frontier (47).

Greedy is myopic and plateaued at 46 (exp_0003). The trusted
...
ordering. is_induced_path audits the result.

novelty = frontier-search. Frontier: snake_len_dim7.
"""
...
MANIFEST = {
    ...
    "title": "Backtracking snake in Q_7 (47 edges)",
    "hypothesis": "Priority-guided backtracking beats the greedy snake frontier (46) in Q_7.",
    "falsifiable_prediction": "The path passes is_induced_path and exceeds 46.",
...
def run(budget_seconds: float) -> dict:
    ...
    prior = 46                                         # greedy frontier (exp_0003)
