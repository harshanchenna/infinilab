"""exp_0002 -- evolved priority opens the Q_6 snake frontier (25 edges).
...
dim-6 champion and record the snake length (edges).
...
MANIFEST = {
    ...
    "title": "Evolved priority builds a 25-edge snake in Q_6",
    "hypothesis": "The evolved champion priority builds a long valid snake in Q_6.",
